 ...
 */
export declare const LOCAL_FETCH_CLIENT_VERSION = "2.4.0";
 ...
 */
export declare function assertPublicUrlTarget(value: unknown, signal: AbortSignal, resolveAddresses?: LocalFetchOptions['resolveAddresses']): Promise<string>;
/**
