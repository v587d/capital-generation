...
import type { SessionLike, TimeAxisSnapshot } from './store.js';
/**
 ...
 */
export declare function normalizeQueryDates(input: {
    store: TimeAxisProbe;
    session: SessionLike;
    dataset_id: string;
    query: QuerySpec;
 ...
 */
export declare function withIsoTimeColumns(result: Record<string, unknown>, axis: {
    column: string;
    time_zone?: string;
}): void;
